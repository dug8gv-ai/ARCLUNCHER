            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-2xl overflow-hidden bg-[var(--bg-card)] border border-[var(--border-dim)] shadow-sm flex-shrink-0">
                ...
                <div className="flex items-center gap-2">
                  {partner.twitter && (
                    <a
                      ...
                      className="w-8 h-8 rounded-xl bg-[var(--bg-card)] border border-[var(--border-dim)] hover:bg-[rgba(0,242,254,0.05)] hover:text-[#1DA1F2] hover:border-[var(--border-dim)] flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors"
                      title="Follow on X"
                    >
                      <XIcon />
                    </a>
                  ...
                  {partner.discord && (
                    <div
                      className="w-8 h-8 rounded-xl bg-[var(--bg-card)] border border-[var(--border-dim)] hover:bg-indigo-50 hover:text-[#5865F2] hover:border-indigo-200 flex items-center justify-center text-[var(--text-secondary)] transition-colors cursor-pointer"
