        ...
        {activeTab === 'create' && (
          <div className="lg:col-span-12 card rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
            ...
            <form onSubmit={handleCreateAgreement} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3.5 max-h-[220px] overflow-y-auto pr-1">
                  {milestones.map((m, idx) => (
                    <div key={idx} className="flex gap-4 items-center bg-[var(--bg-card)] border border-[var(--border-dim)] rounded-2xl p-4">
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--border-dim)] rounded-2xl p-4 text-[10.5px] font-bold text-[var(--text-secondary)] leading-normal flex items-start gap-3">
