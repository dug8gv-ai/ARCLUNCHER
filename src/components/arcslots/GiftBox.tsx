      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div className="w-full max-w-md rounded-xl bg-gradient-to-b from-slate-800 via-slate-900 to-black border border-cyan-500/20 shadow-2xl">
          ...
          <div className="flex items-center justify-between p-6 border-b border-slate-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Claim your ARC tokens</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-6 space-y-4 max-h-96 overflow-y-auto">
            {isLoading ? (
              ...
              <div className="text-center py-8">
                <p className="text-slate-400">No pending payouts yet</p>
                <p className="text-xs text-slate-500 mt-2">Keep spinning to earn rewards!</p>
              </div>
              ...
              remainingPayouts.map((payout) => (
                <div
                  ...
                  className="p-4 rounded-lg bg-slate-700/50 border border-slate-600 hover:border-cyan-500/50 transition-colors"
                >
          ...
          {pendingPayouts.length > 0 && (
            <div className="p-6 border-t border-slate-700 bg-slate-800/50">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-xs text-slate-400 uppercase font-semibold tracking-wider">Total Pending</p>
                ...
                <div>
                  <p className="text-xs text-slate-400 uppercase font-semibold tracking-wider">Remaining</p>
          ...
          <div className="p-4 border-t border-slate-700">
            <button
              onClick={onClose}
              className="w-full px-4 py-2 text-sm font-semibold text-slate-300 rounded-lg border border-slate-600 hover:border-slate-500 hover:text-white transition-colors"
            >
              Close
            </button>
          </div>
